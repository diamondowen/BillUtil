...
def loadData(month, year, visualization, highlight_threshold, root_folder = "Data"):
...
@click.option('-v','--visualization',type=click.BOOL, default=False, help='Visualize result')
@click.option('-t', '--highlight_threshold', type=click.FLOAT, default=100, help='Threshold of highlight spending in result')
def processDataOnMonthAndYear(month, year, visualization, highlight_threshold):
    print "Month of interst:", month, "/", year
    loadData(month, year, visualization, highlight_threshold)
